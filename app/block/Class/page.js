...
export default function AcademicBuildingsMaintenance() {
  const [loginOpen, setLoginOpen] = useState(false);
  const [complaintOpen, setComplaintOpen] = useState(false);
  const [rooms, setRooms] = useState(() => generateRooms("CR"));
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      <div className="bg-primary text-white py-2">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/share/16YdrdUQSX/" className="hover:text-secondary"><i className="ri-facebook-line ri-lg" /></a>
            ...
            <a href="https://www.instagram.com/ifyk_ykmf?igsh=MW9jNTZxeno1dTlndg==" className="hover:text-secondary"><i className="ri-instagram-line ri-lg" /></a>
          </div>
        </div>
      </div>
      {/* Header */}
      ...
      <main className="relative flex-1">
        ...
        <div className="max-w-7xl mx-auto relative z-10 px-4 py-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Academic Buildings Maintenance</h1>
        ...
        {complaintOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none" aria-modal="true" role="dialog">
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full relative border border-gray-200 pointer-events-auto">
              ...
              <select
                id="category"
                className="w-full mb-4 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-900"
                value={category}
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/16YdrdUQSX/" className="text-gray-400 hover:text-white"><i className="ri-facebook-line ri-lg" /></a>
                ...
                <a href="https://www.linkedin.com/in/kinley-tenzin-a4abb7320?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="text-gray-400 hover:text-white"><i className="ri-linkedin-line ri-lg" /></a>
                <a href="https://www.instagram.com/ifyk_ykmf?igsh=MW9jNTZxeno1dTlndg==" className="text-gray-400 hover:text-white"><i className="ri-instagram-line ri-lg" /></a>
              </div>
            </div>
            <div>
